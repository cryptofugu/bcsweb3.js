...
class BCSweb3 {
  /**
   * BCSweb3 constructor.
   * @param {string|BCSweb3Provider} provider Either URL string to create HttpProvider or a BCSweb3 compatible provider.
   */
   ...
   * @param {number} blocks How many blocks are generated immediately.
   * @param {string} address The address to send the newly generated bcs to.
   * @param {number} maxTries How many iterations to try (default = 1000000).
   * @return {array} Hashes of blocks generated.
   */
  ...
  /** ******** RAW TRANSACTIONS ********* */
  /**
   * Get the hex address of a BCS address.
   * @param {string} address BCS address
  ...
  /**
   * Converts a hex address to bcs address.
   * @param {string} hexAddress BCS address in hex format.
   * @return {Promise} BCS address or Error.
   */
  ...
  /** ******** UTIL ********* */
  /**
   * Validates if a valid BCS address.
   * @param {string} address BCS address to validate.
   ...
   * @param {string} address The bcs address for the private key.
  ...
  /**
   * Encrypts the wallet for the first time. This will shut down the bcs server.
  ...
  /**
   * Gets the account name associated with the BCS address.
   * @param {string} address The bcs address for account lookup.
  ...
  /**
   * Gets the BCS address based on the account name.
  ...
  /**
   * Gets the BCS address with the account name.
   * @param {string} acctName The account name ("" for default).
   * @return {Promise} BCS address array or Error.
   */
  ...
  /**
   * Gets a new BCS address for receiving payments.
   ...
   * @return {Promise} Array of addresses with BCS balances or Error.
   */
  ...
  /**
   * Lists unspent transaction outputs.
   * @param {string} address Address to send BCS to.
   * @param {number} amount Amount of BCS to send.
   ...
   * @param {string} senderAddress The BCS address that will be used to send money from.
   ...
   * @param {bumber} amount The transaction fee in BCS/kB.
